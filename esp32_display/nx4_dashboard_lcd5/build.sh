...
FQBN="esp32:esp32:esp32p4:FlashSize=32M,PartitionScheme=app13M_data7M_32MB,PSRAM=enabled,FlashMode=qio,FlashFreq=80,UploadSpeed=921600,CDCOnBoot=cdc,USBMode=hwcdc,ChipVariant=postv3"
