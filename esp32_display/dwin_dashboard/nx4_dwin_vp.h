...
// 內容 = 描述 0x06 之後的那幾個字。
static const uint16_t SP_INIT_SPEED[13] = {0x2000, 0x01B0, 0x0018, 0xFFFF, 0x00E6, 0x0103, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000};
static const uint16_t SP_INIT_RPM[13] = {0x2001, 0x0233, 0x00F8, 0x2BFE, 0x0058, 0x0104, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000};
static const uint16_t SP_INIT_COOLANT[13] = {0x2003, 0x0026, 0x00D6, 0xFFFF, 0x0048, 0x0003, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000};
static const uint16_t SP_INIT_LIMIT[13] = {0x2006, 0x03CE, 0x0172, 0xFFFF, 0x0048, 0x0003, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000};
